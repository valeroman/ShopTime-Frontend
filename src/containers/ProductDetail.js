...
const ProductDetail = ({ 
    ...
    }, [match.params.id, get_product, get_related_products]);
    ...
    return (
        <div className='container mt-5'>
            ...
            <section className='mt-5 mb-5'>
                <div className='row'>
                    <div className='col-3'>
                        <h2 className='mb-3'>Filter Reviewa</h2>
                        <button
                        ...
                        <p className='mb-3'>
                            Share you thoughts with other customer
                        </p>
